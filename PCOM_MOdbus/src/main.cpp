...
*/
//#define  LED 9 (inutilizada por comentário)
...
enum
{
  ...
  TEMP1_VAL,
  TEMP2_VAL,
  //PWM_VAL, (inutilizada por comentário)
...
void setup()
{
  ...
  */
  ...
  //pinMode(LED, OUTPUT); (inutilizada por comentário)
}
...
void loop()
{
  ...
  holdingRegs[TEMP1_VAL] = analogRead(a0);
  holdingRegs[TEMP2_VAL] = analogRead(a1);

  //analogWrite(LED, holdingRegs[PWM_VAL]>>2); // constrain adc value from the arduino master to 255 (inutilizada por comentário)
